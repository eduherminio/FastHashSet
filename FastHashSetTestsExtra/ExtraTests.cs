...
namespace FastHashSetTestsExtra
{
    public class ExtraTests
    {
        ...
        public void FindOrAdd()
        {
            ...
            ref IDCount xRef = ref set.FindOrAdd(in x, out bool isFound);
            if (isFound)
            {
                xRef.count++;
            }
        ...
        public void Find()
        {
            ...
            set.Add(new IDCount(10, 1));
            set.Add(new IDCount(11, 1));
            ref IDCount xRef = ref set.Find(in x, out bool isFound);
            if (isFound)
            {
                xRef.count++;
            }
        ...
        public void FindAndRemoveIf()
        {
            ...
            xRef = ref set.FindAndRemoveIf(in x, n => n.count == 1, out isFound, out bool isRemoved);
